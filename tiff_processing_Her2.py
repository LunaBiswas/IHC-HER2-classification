...
def row_major_numpy128_patchify(region):
    '''
    Creates 35 patches of size tile_height x tile_width from an aoi
    '''

    patches = cp.zeros((num_tiles,tile_height,tile_width,3))
    patch_num = 0
...
if __name__=='__main__':
   ...
   #
    ...
    # net = torch.load('/nvme1_drive/code/Her2/Her2Models/HNEHer2_net_GAP_495.pth')
    # # PATH1 = '/nvme1_drive/code/Her2/Her2Models/HNEHer2_net_GAP_TRT_495.pth'
    # model_scripted = torch.jit.script(net) # Export to TorchScript
    # model_scripted.save(PATH1)


    # model takes batch of 35 for base tiles coming from an AOI
  #  her2_model=torch.jit.load(PATH1)
 #   her2_model=torch.jit.load('/nvme1_drive/code/Her2/Her2Models/HNEHer2_net_GAP_TRT_495.pth ')
    her2_model = Net()
    torch_model_path = '/media/adminspin/558649a1-21fd-43b8-b53d-7334f802b47a/wsi_tb_data/Her2/code/Her2Models/HNEHer2_net_GAP.pth'

    her2_model.load_state_dict(torch.load('/media/adminspin/558649a1-21fd-43b8-b53d-7334f802b47a/wsi_tb_data/Her2/code/Her2Models/HNEHer2_net_GAP.pth'))
    her2_model.load_state_dict(torch.load(torch_model_path))
 #  her2_model = torch.load('/nvme1_drive/code/Her2/Her2Models/HNEHer2_net_GAP_495.pth')
      
    her2_model.eval().to(device)

    timelog_data = {"her2_model":[]}
